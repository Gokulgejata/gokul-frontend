...
var e0 = (() => {
  ...
  return function(i = {}) {
    ...
    var a1 = 0, m1 = null;
    function F1(t) {
      throw s.onAbort?.(t), t = "Aborted(" + t + ")", $(t), s1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), M(t), t;
    }
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    (async function() {
      function t(n) {
        return y = n.exports, q = y.la, i1(), k = y.qa, B.unshift(y.ma), a1--, s.monitorRunDependencies?.(a1), a1 == 0 && m1 && (n = m1, m1 = null, n()), y;
      }
    ...
    function j2() {
      function t() {
        if (!j1 && (j1 = true, s.calledRun = true, !s1)) {
          if (Q1(B), v(s), s.onRuntimeInitialized?.(), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
...
var Z2 = class C {
  ...
  get mode() {
    ...
    return i === C._wasmModule?.Mode.Reverse ? "reverse" : i === C._wasmModule?.Mode.Bounce ? "bounce" : i === C._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  destroy() {
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), O && this._canvas instanceof HTMLCanvasElement && (Q.unobserve(this._canvas), X.unobserve(this._canvas)), this._dotLottieCore?.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  tween(i, r) {
    ...
    return this._dotLottieCore?.tween(i, r, v) ?? false;
  }
  tweenToMarker(i, r) {
    if (!C._wasmModule) return false;
    let s = [0, 0, 1, 1], v = new C._wasmModule.VectorFloat();
    for (let M of s) v.push_back(M);
    return this._dotLottieCore?.tweenToMarker(i, r, v) ?? false;
  }
  static transformThemeToLottieSlots(i, r) {
    return C._wasmModule?.transformThemeToLottieSlots(i, r) ?? "";
  }
};
...
var _2 = class r1 {
  ...
  async _create(i) {
    ...
    let { instanceId: s } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: r }, ...V2(this._canvas, i.renderConfig?.devicePixelRatio || o1()) }, [r]);
...
var V1 = ({ animationId: d, autoplay: i, backgroundColor: r, className: s, createDotLottie: v, data: M, dotLottieRefCallback: z, layout: F, loop: G, mode: E, playOnHover: l1, renderConfig: u1, segment: $, speed: K, src: q, style: s1, themeData: h1, themeId: N, useFrameInterpolation: I, workerId: t1, ...J }) => {
  ...
  let E1 = (0, import_react.useCallback)((B) => {
    w.current = B, B ? L.current = v({ ...i1.current, canvas: B }) : (L.current?.destroy(), L.current = null), f1.current?.(L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let B = (v1) => {
      l1 && (v1.type === "mouseenter" && L.current?.play(), v1.type === "mouseleave" && L.current?.pause());
    };
    return w.current?.addEventListener("mouseenter", B), w.current?.addEventListener("mouseleave", B), () => {
      w.current?.removeEventListener("mouseenter", B), w.current?.removeEventListener("mouseleave", B);
    };
    ...
    L.current?.setUseFrameInterpolation(I ?? true);
    ...
    typeof M != "string" && typeof M != "object" || L.current?.load({ data: M, ...i1.current });
    ...
    typeof N == "string" && L.current?.setTheme(N);
